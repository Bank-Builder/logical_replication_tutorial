...
docker exec -it db2 psql -h 127.0.0.1 -U postgres -p 5432 -d test -c "CREATE SUBSCRIPTION edge_sub CONNECTION 'dbname=test host=$DB_1 user=repuser password=password' PUBLICATION edge_pub WITH (copy_data = true);"
